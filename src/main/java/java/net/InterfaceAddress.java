...
public class InterfaceAddress {
    ...
    private InterfaceAddress() {
        throw new RuntimeException("This class is only to be used on systems where no java.net.InterfaceAddress is available!");
    }
    public InterfaceAddress(Inet4Address address, Inet4Address broadcast, Inet4Address mask) {
        this.address = address;
        this.broadcast = broadcast;
        this.prefixLength = countPrefixLength(mask);
    }
    
    public InterfaceAddress(Inet6Address address, short prefixLength) {
        this.address = address;
        this.broadcast = null;
    ...
    public boolean equals(Object obj) {
        ...
        return ((address == null) ? rhs.address == null : address.equals(rhs.address))
                ...
                && ((broadcast == null) ? rhs.broadcast == null
                : broadcast.equals(rhs.broadcast));
    }

    @Override
    public int hashCode() {
        int hashCode = address == null ? 0 : -address.hashCode();
        hashCode += broadcast == null ? 0 : broadcast.hashCode();
    ...
    public String toString() {
        return address + "/" + prefixLength + " [" + broadcast
                + "]";
    }
